...
#---------------------------------------------------------------------------------------------------
    ...
    url(r'^operasyon_list/(?P<pk>\d+)/update/$', views.operasyon_update, name='operasyon_update'),
    url(r'^operasyon_list/find_update/$', views.operasyon_find_update, name='operasyon_find_update'),
    ...
    url(r'^den_saha_list/(?P<pk>\d+)/update/$', views.den_saha_update, name='den_saha_update'),
    url(r'^den_saha_list/find_update/$', views.den_saha_find_update, name='den_saha_find_update'),
    url(r'^ariza_create/$', views.ariza_create, name='ariza_create'),
    url(r'^ariza_list/$', views.ariza_list, name='ariza_list'),
    url(r'^ariza_list/(?P<pk>\d+)/update/$', views.ariza_update, name='ariza_update'),
    url(r'^ariza_list/find_update/$', views.ariza_find_update, name='ariza_find_update'),
    ...
    url(r'^yerud_list/find_update/$', views.yerud_find_update, name='yerud_find_update'),
